...
/*A user privilege is a right to execute a particular type of SQL statement,
  or a right to access another user's object. The types of privileges are defined by Oracle.
  Roles, on the other hand, are created by users
  (usually administrators) and are used to group together privileges or other roles.
...
grant administrator to "D_admin";
grant support to "D_support";

grant olzhas to "D_admin";
